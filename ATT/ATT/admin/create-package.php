...
<html>
<head>
<title>TIS | Admin Package Creation</title>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Price in Naira</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is Naira" required>
									</div>
								</div>
